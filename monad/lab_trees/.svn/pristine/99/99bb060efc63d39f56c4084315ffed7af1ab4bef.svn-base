...
class BinaryTree
{
  ...
  public:
    ...
    bool isOrderedHelp(Node* n) const;
    vector<T> inOrderTraversal(Node* n1) const;
    void inOrderTraversalHelp(Node* n2, vector<T>& vec) const;
    ...
    void printPathsHelp(Node* n, vector<T>& vec) const;
    ...
    void sumDistancesHelp(Node* n, vector<T>& vec) const;
    int distance(Node* start, Node* n, int length) const;
